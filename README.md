...
2. **Tool-Calling Stability:** Llama 3.2 3B is specifically tuned for function calling, avoiding the "beta endpoint" errors common in Cloud APIs.
...
## 🎥 Flow & Features
- **Dual-Engine:** Uses Gemini 2.0 Flash-Lite for speed and Llama 3.2 for local fallback.
